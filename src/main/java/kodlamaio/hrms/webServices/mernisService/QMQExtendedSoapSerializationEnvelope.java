...
public class QMQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QMQDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QMQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QMQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QMQDateTimeConverter dateTimeConverter = new QMQStandardDateTimeConverter();

    public QMQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QMQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QMQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=QMQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QMQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QMQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
