...
public class QMQKPSPublicSoap
{
    ...
    public QMQKPSPublicSoap(){}

    public QMQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QMQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QMQExtendedSoapSerializationEnvelope envelope= new QMQExtendedSoapSerializationEnvelope(QMQExtendedSoapSerializationEnvelope.VER11);
